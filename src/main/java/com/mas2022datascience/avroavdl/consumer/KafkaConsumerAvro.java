...
public class KafkaConsumerAvro {
    ...
    private static Consumer<String, Frame> createConsumer() {
        ...
        final Consumer<String, Frame> consumer =
    ...
    static void runConsumer(int waitMsInBetween) throws InterruptedException {
        final Consumer<String, Frame> consumer = createConsumer();

        final int giveUp = 100;
        int noRecordsCount = 0;

        while (true) {
            final ConsumerRecords<String, Frame> consumerRecords = consumer.poll(1000);
